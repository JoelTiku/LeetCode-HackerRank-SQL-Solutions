...
"2021-02-01 09:30:00" with two different IP addresses (1 and 2). It should be banned.
...
ON l1.account_id = l2.account_id AND l2.[login] > l1.[login] AND l2.[login] <= l1.[logout]
